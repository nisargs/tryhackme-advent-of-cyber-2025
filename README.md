...
The challenges provided hands-on experience across the entire security spectrum, including:
* **Web Application Security:** XSS, SQLi, Race Conditions, and API Exploitation.
* **Blue Team & Forensics:** Log analysis (Splunk/Zeek), Malware Reverse Engineering, and Registry Forensics.
* **Cloud & Infrastructure:** AWS Privilege Escalation, Docker Breakouts, and SCADA/ICS Security.
* **Scripting & Automation:** Python, Bash, YARA rules, and PowerShell de-obfuscation.
